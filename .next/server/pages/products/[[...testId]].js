...
async function getStaticProps({ params , ...other }) {
    console.log(other);
    return {
        props: {
            params
...
function Products({ params  }) {
    ...
    if (router.isFallback) {
        return /*#__PURE__*/ react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx("div", {
            children: "Loading..."
        }) //not expected to render due to fallback is "blocking" not true
        ;
    }
...
var __webpack_exports__ = __webpack_require__.X(0, [895,664,546], () => (__webpack_exec__(8316)));
